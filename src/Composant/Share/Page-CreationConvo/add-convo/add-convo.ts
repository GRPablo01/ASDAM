/* =========================================================
   ADD CONVO COMPONENT - FINAL VERSION 2026
   ========================================================= */
  ...
  export class AddConvo implements OnInit {
    ...
    private handleJoueurs(joueurs: Joueur[]): void {
      ...
      this.joueursEquipe = this.allJoueurs.filter(
        j =>
          this.normalizeEquipe(j.equipe) ===
          this.normalizeEquipe(this.equipeUser)
      );
    ...
    nextStep(): void {
      ...
      if (
        ...
        this.convocationForm.get('equipeDom')?.valid &&
        this.convocationForm.get('equipeExt')?.valid &&
        this.convocationForm.get('TypeCompetition')?.valid &&
    ...
    ajouterConvocation(): void {
      ...
      const data: Convocation = {
        ...
        equipeDom: this.convocationForm.value.equipeDom,
        equipeExt: this.convocationForm.value.equipeExt,
        TypeCompetition: this.convocationForm.value.TypeCompetition,
