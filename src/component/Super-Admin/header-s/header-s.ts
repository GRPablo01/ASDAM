...
@Component({
  ...
  templateUrl: './header-s.html',
  styleUrls: ['./header-s.css']
})
export class HeaderS implements OnInit, AfterViewInit {
    ...
    this.mobileMenus = [
      {
        ...
        link: '/actualiteS',
        items: [
          { title: 'Communiqués', link: '/actualiteS/communiquesS', icon: 'fas fa-bullhorn' },
      ...
      },
      {
        ...
        link: '/matchS',
        items: [
          { title: 'Convocations', link: '/matchS/convocationsS', icon: 'fas fa-users' },
          { title: 'Résultats', link: '/matchS/resultatsS', icon: 'fas fa-trophy' }
        ]
      },
      ...
      { title: 'Utilisateur', icon: 'fas fa-people-group', link: '/joueurS', items: [] },
      {
        ...
        link: '/dashboardS',
        items: [
          { title: 'Mon Profil', link: '/dashboardS/profileS', initiales },
          { title: 'Paramètres', link: '/dashboardS/settingsS', icon: 'fas fa-cog' },
