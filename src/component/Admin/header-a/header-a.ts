...
@Component({
  ...
  styleUrls: ['./header-a.css']
})
export class HeaderA implements OnInit, AfterViewInit {
    ...
    this.mobileMenus = [
      {
        ...
        link: '/actualiteA',
        items: [
          { title: 'Communiqués', link: '/actualiteA/communiquesA', icon: 'fas fa-bullhorn' },
      ...
      },
      {
        ...
        link: '/matchA',
        items: [
          { title: 'Convocations', link: '/matchA/convocationsA', icon: 'fas fa-users' },
          { title: 'Résultats', link: '/matchA/resultatsA', icon: 'fas fa-trophy' }
        ]
      },
      { title: 'Planning', icon: 'fas fa-calendar-alt', link: '/PlanningA', items: [] },
      { title: 'Messages', icon: 'fas fa-envelope', link: '/messagesA', items: [] },
      { title: 'Joueur', icon: 'fas fa-people-group', link: '/joueurA', items: [] },
      {
        title: 'Dashboard',
        icon: 'fas fa-tachometer-alt',
        link: '/dashboardA',
        items: [
          { title: 'Mon Profil', link: '/dashboardA/profileA', initiales },
          { title: 'Paramètres', link: '/dashboardA/settingsA', icon: 'fas fa-cog' },
