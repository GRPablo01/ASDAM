...
import { DetailSeance } from '../../../Composant/Share/Page-Detail/detail-seance/detail-seance';
import { DetailMatch } from '../../../Composant/Share/Page-Detail/detail-match/detail-match';
import { DetailEvent } from '../../../Composant/Share/Page-Detail/detail-event/detail-event';




@Component({
  selector: 'app-detail-event2',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './detail-event2.html',
  styleUrls: ['./detail-event2.css'],
})
export class DetailEvent2 implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('ASDAM | Détail Event');
