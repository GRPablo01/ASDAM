...
import { AddEquipe } from '../../../Composant/Share/Page-CreationEquipe/add-equipe/add-equipe';
...
@Component({
  ...
  templateUrl: './creation-equipe.html',
  styleUrls: ['./creation-equipe.css'],
})
export class CreationEquipe implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('ASDAM | Création Equipe');
