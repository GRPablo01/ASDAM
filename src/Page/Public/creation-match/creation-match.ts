...
import { AddMatch } from '../../../Composant/Share/Page-CreationMatch/add-match/add-match';
...
@Component({
  ...
  templateUrl: './creation-match.html',
  styleUrls: ['./creation-match.css'],
})
export class CreationMatch implements OnInit {
