...
import { CoupEnvoi } from '../../../Composant/Share/Page-CoupEnvoi/coup-envoi/coup-envoi';
...
@Component({
  ...
  templateUrl: './coupe-envoie.html',
  styleUrls: ['./coupe-envoie.css'],
})
export class CoupeEnvoie implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle("ASDAM | Coup D'envoi");
