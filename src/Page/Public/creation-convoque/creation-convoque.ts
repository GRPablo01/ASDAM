...
import { AddConvo } from '../../../Composant/Share/Page-CreationConvo/add-convo/add-convo';



@Component({
  selector: 'app-creation-convo',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './creation-convoque.html',
  styleUrls: ['./creation-convoque.css'],
})
export class CreationConvoque implements OnInit {
