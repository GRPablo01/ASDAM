...
@Component({
  ...
  templateUrl: './detail-match2.html',
  styleUrls: ['./detail-match2.css'],
})
export class DetailMatch2 implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('ASDAM | Détail Match');
